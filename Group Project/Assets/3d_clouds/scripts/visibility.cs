		...
		foreach (Transform child in transform)
{
	...
	if (this.name=="cloud1" && this.transform.Find("l1").GetComponent<Renderer>().enabled==true && act1=="1"){
			foreach (Transform child in transform)
{
    child.GetComponent<Renderer>().enabled=false;
			...
			if (this.name=="cloud2" && this.transform.Find("l1").GetComponent<Renderer>().enabled==true && act2=="2"){
			foreach (Transform child in transform)
{
    child.GetComponent<Renderer>().enabled=false;
			}
			...
			if (this.name=="cloud3" && this.transform.Find("l1").GetComponent<Renderer>().enabled==true && act3=="3"){
			foreach (Transform child in transform)
{
    child.GetComponent<Renderer>().enabled=false;
			}
			...
			if (this.name=="cloud4" && this.transform.Find("l1").GetComponent<Renderer>().enabled==true && act4=="4"){
			foreach (Transform child in transform)
{
    child.GetComponent<Renderer>().enabled=false;
			}
			...
			if (this.name=="cloud5" && this.transform.Find("l1").GetComponent<Renderer>().enabled==true && act5=="5"){
			foreach (Transform child in transform)
{
    child.GetComponent<Renderer>().enabled=false;
			}
			...
			if (this.name=="cloud6" && this.transform.Find("l1").GetComponent<Renderer>().enabled==true && act6=="6"){
			foreach (Transform child in transform)
{
    child.GetComponent<Renderer>().enabled=false;
			}
